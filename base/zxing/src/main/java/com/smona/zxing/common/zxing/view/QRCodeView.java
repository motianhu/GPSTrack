...
import com.smona.zxing.common.zxing.core.BeepManager;
import com.smona.zxing.common.zxing.util.BarcodeType;
import com.smona.zxing.common.zxing.core.ProcessDataTask;
...
public abstract class QRCodeView extends RelativeLayout implements Camera.PreviewCallback {
    ...
    public boolean changedFlashLight() {
    ...
    private void onSpotSuccess(String result) {
        if (mDelegate != null) {
            if (mBeepManager != null) {
    ...
    public void isNetOffline(boolean isNetOffline) {
        if (mScanBoxView != null) {
            mScanBoxView.isNetOffline(isNetOffline);
        }
    }
