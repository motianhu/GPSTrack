 ...
 */
package com.smona.gpstrack.guide.pageIndicator;
...
public class LinePageIndicator extends View implements PageIndicator {
    ...
    public LinePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final float defaultLineWidth = res.getDimension(R.dimen.dimen_4dp);
        final float defaultGapWidth = res.getDimension(R.dimen.dimen_8dp);
        final float defaultStrokeWidth = res.getDimension(R.dimen.dimen_4dp);
        ...
        mRadius = a.getDimension(R.styleable.LinePageIndicator_lineWidth, defaultLineWidth);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float lineWidthAndGap = 2 * mRadius + mGapWidth;
        ...
        for (int i = 0; i < count; i++) {
            ...
            float dx2 = dx1 + mRadius;
            canvas.drawCircle((dx2 - dx1) / 2 + dx1, verticalOffset, mRadius, (i == mCurrentPage) ? mPaintSelected : mPaintUnselected);
        }
    }
