...
import com.smona.gpstrack.widget.adapter.animation.AlphaInAnimation;
import com.smona.gpstrack.widget.adapter.animation.BaseAnimation;
import com.smona.gpstrack.widget.adapter.animation.ScaleInAnimation;
import com.smona.gpstrack.widget.adapter.animation.SlideInBottomAnimation;
import com.smona.gpstrack.widget.adapter.animation.SlideInLeftAnimation;
import com.smona.gpstrack.widget.adapter.animation.SlideInRightAnimation;
...
public abstract class BaseQuickAdapter<D, H extends BaseViewHolder> extends RecyclerView.Adapter<H> {
     ...
     */
    public BaseQuickAdapter(@LayoutRes int layoutResId, @Nullable List<D> data) {
    ...
    public BaseQuickAdapter(@Nullable List<D> data) {
        this(0, data);
    }
     ...
     * @param data
     */
    public void setNewData(@Nullable List<D> data) {
        this.mData = data == null ? new ArrayList<D>() : data;
    ...
    public void setNewData(@Nullable D data) {
     ...
     * change data
     */
    public void setData(@IntRange(from = 0) int index, @NonNull D data) {
     ...
     */
    public void addData(@IntRange(from = 0) int position, @NonNull Collection<? extends D> newData) {
     ...
     */
    public void replaceData(@NonNull Collection<? extends D> data) {
        // 不是同一个引用才清空列表
        if (data != mData) {
            mData.clear();
            mData.addAll(data);
    ...
    protected H createBaseViewHolder(View view) {
        ...
        // 泛型擦除会导致z为null
        if (z == null) {
            k = (H) new BaseViewHolder(view);
        } else {
            k = createGenericKInstance(z, view);
        }
        return k != null ? k : (H) new BaseViewHolder(view);
    }
