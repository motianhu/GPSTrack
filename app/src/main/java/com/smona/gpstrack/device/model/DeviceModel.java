...
public class DeviceModel implements IModel {
    public void addDevice(UrlBean urlBean, ReqAddDevice addDevice, OnResultListener<RespIdBean> listener) {
        ...
        new GpsDynamicBuilder<RespIdBean>(GpsDynamicBuilder.REQUEST_POST, api).requestData(addDevice, httpCallbackProxy);
    }
